...
kubectl set image deployments/client-deployment  client=brucezw/multi-client:$SHA
kubectl set image deployments/worker-deployment  worker=brucezw/multi-worker:$SHA